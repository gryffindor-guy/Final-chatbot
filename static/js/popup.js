$(function() {
  ...
  function bot_chat(msg) {
    ...
    if (msg.toLowerCase() == "music") {
    ...
    else if (msg.toLowerCase() == "typing") {
      ...
      var request = new XMLHttpRequest();
		request.open('GET', 'https://cricapi.com/api/matchCalendar?apikey=rZg1beeMaNUrUK2kACGUiuaV0R83', true);
		request.onload = function () {
  			// We can acess JSON data here in API
  			var data = JSON.parse(this.response);
  			for(var i=0;i<data.data.length;i++){
  				if(data.data[i].date==msg){
  ...
  function generate_button_message(msg, buttons){    
    ...
    */
    ...
    str += "            <img src=\"additional_files\/iconr.png\">";
    str += "          <\/span>";
    str += "          <div class=\"cm-msg-text\">";
    str += msg;
    str += "          <\/div>";
